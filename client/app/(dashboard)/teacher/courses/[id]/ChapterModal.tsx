...
const ChapterModal = () => {
    ...
    const chapter: Chapter | undefined = useMemo(() => selectedSectionIndex !== null && selectedChapterIndex !== null
        ? sections[selectedSectionIndex].chapters[selectedChapterIndex]
        : undefined, [sections, selectedChapterIndex, selectedSectionIndex]);
